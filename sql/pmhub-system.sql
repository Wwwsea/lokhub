...
CREATE DATABASE  `lokhub-system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- ----------------------------
-- Table structure for lokhub_async
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_async`;
CREATE TABLE `lokhub_async` (
...
-- ----------------------------
-- Records of lokhub_async
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for lokhub_oauth2_agree
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_oauth2_agree`;
CREATE TABLE `lokhub_oauth2_agree` (
...
-- ----------------------------
-- Records of lokhub_oauth2_agree
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for lokhub_oauth2_client
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_oauth2_client`;
CREATE TABLE `lokhub_oauth2_client` (
  `id` varchar(64) DEFAULT NULL,
...
-- ----------------------------
-- Records of lokhub_oauth2_client
-- ----------------------------
BEGIN;
COMMIT;
...
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `ancestors`, `dept_name`, `order_num`, `leader`, `phone`, `email`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (216, 106, '0,100,211,101,106', 'eee', 1, NULL, NULL, NULL, '0', '2', 'fish', '2023-09-22 09:28:22', '', NULL);
COMMIT;
...
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (8994, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-05-31 23:41:27');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (8995, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-05-31 23:41:39');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (8996, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 13:37:00');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (8997, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 13:37:28');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (8998, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 13:48:40');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (8999, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 13:51:42');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9000, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 13:52:46');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9001, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 13:53:53');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9002, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 14:32:55');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9003, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 14:33:04');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9004, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 15:03:44');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9005, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 15:04:39');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9006, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 15:05:22');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9007, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 15:07:24');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9008, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 15:07:55');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9009, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 15:14:16');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9010, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 15:14:47');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9011, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 15:15:09');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9012, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 15:23:18');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9013, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 15:39:24');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9014, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 15:39:52');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9015, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 15:40:10');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9016, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-01 15:41:17');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9017, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-01 15:41:28');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9018, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-02 05:01:21');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9019, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-02 05:10:25');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9020, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-02 05:10:41');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9021, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-02 05:15:29');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9022, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-02 05:15:42');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9023, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-02 05:15:52');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9024, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-02 05:16:07');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9025, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '退出成功', '2024-06-02 14:07:08');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9026, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-02 14:07:25');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9027, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-16 22:39:30');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9028, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-16 23:54:42');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9029, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:53:00');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9030, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:11');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9031, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:11');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9032, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:11');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9033, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:11');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9034, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:11');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9035, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:11');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9036, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:12');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9037, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:12');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9038, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:55:12');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9039, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9040, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9041, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9042, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9043, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9044, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9045, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9046, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9047, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:06');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9048, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-19 02:58:07');
INSERT INTO `sys_logininfor` (`info_id`, `user_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (9049, 'admin', '127.0.0.1', NULL, NULL, NULL, '0', '登录成功', '2024-06-21 05:59:51');
COMMIT;
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2001, '项目管理', 0, 2, 'lokhub-project', NULL, NULL, 1, 0, 'M', '0', '0', '', 'tab', 'admin', '2022-12-08 09:54:31', 'admin', '2024-03-05 06:02:10', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2002, '我的项目', 2001, 1, 'my-project', 'lokhub-project/my-project', NULL, 1, 1, 'C', '0', '0', 'lokhub-project:my-project', 'list', 'admin', '2022-12-08 09:57:17', 'admin', '2024-03-05 06:02:00', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2003, '我的收藏', 2001, 3, 'my-collection', 'lokhub-project/my-collection', NULL, 1, 1, 'C', '0', '0', 'lokhub-project:my-collection', 'list', 'admin', '2022-12-08 10:01:23', 'admin', '2024-03-05 06:02:30', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2004, '我的任务', 2001, 2, 'my-task', 'lokhub-project/my-task', NULL, 1, 1, 'C', '0', '0', 'lokhub-project:my-task', 'list', 'admin', '2022-12-08 10:02:19', 'admin', '2024-03-05 06:02:23', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2005, '回收站', 2001, 4, 'recycle-bin', 'lokhub-project/recycle-bin', NULL, 1, 1, 'C', '0', '0', 'lokhub-project:recycle-bin', 'list', 'admin', '2022-12-08 10:03:09', 'admin', '2024-03-05 06:02:38', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2016, '详情', 2002, 4, '', NULL, NULL, 1, 0, 'F', '0', '0', 'lokhub-project:my-project:info', '#', 'admin', '2022-12-12 10:33:04', 'admin', '2024-04-03 17:40:11', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2018, '详情', 2004, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'lokhub-project:my-task:info', '#', 'admin', '2022-12-20 09:42:12', 'admin', '2024-06-01 15:45:21', '');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_notice` (`notice_id`, `notice_title`, `notice_type`, `notice_content`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, '温馨提醒：2018-07-01 lokhub新版本发布啦', '2', 0x3C703E3C696D67207372633D222F6465762D6170692F70726F66696C652F75706C6F61642F323032332F30312F30342F77616C6C686176656E2D7A386D7A6F765F3230323330313034313730333334413030332E706E67223EE696B0E78988E69CACE58685E5AEB93C2F703E, '0', 'admin', '2022-12-06 17:32:35', 'admin', '2023-01-04 17:03:37', '管理员');
INSERT INTO `sys_notice` (`notice_id`, `notice_title`, `notice_type`, `notice_content`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, '维护通知：2018-07-01 lokhub系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin', '2022-12-06 17:32:35', '', NULL, '管理员');
...
INSERT INTO `sys_user` (`user_id`, `dept_id`, `leader_id`, `user_name`, `user_wx_name`, `nick_name`, `user_type`, `email`, `phonenumber`, `sex`, `avatar`, `password`, `status`, `del_flag`, `login_ip`, `login_date`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (134, 106, '1', 'fish', 'fish', '苍何', '00', '268231256@qq.com', '18212382341', '0', '', '$2a$10$L7rDjeeLezuwD9vdryb3UuuyrAbXjG4MQCugRfIxnwP2EHiY3I1Cy', '0', '2', '183.69.244.46', '2024-01-10 23:01:04', 'admin', '2023-03-13 15:05:06', 'admin', '2024-03-05 06:51:27', NULL);
