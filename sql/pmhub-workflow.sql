...
*/
CREATE DATABASE  `lokhub-workflow` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- ----------------------------
-- Records of lokhub_task_message_deal
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of lokhub_wf_category
-- ----------------------------
BEGIN;
INSERT INTO `lokhub_wf_category` (`category_id`, `category_name`, `code`, `remark`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`) VALUES (1793475859094540290, '信息流转流程', '123456', '123456', '', NULL, '', NULL, '0');
COMMIT;
...
-- ----------------------------
-- Records of lokhub_wf_deploy_form
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Records of lokhub_wf_model_deploy
-- ----------------------------
BEGIN;
INSERT INTO `lokhub_wf_model_deploy` (`id`, `model_id`, `deployed`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('0d752fa5a7981ae3ee28ca290482449c', 'f7ba4dcd-18af-11ef-bdc0-0242ac110002', 0, 'laige', '2024-05-23 10:55:53', 'laige', '2024-05-23 10:55:53');
COMMIT;


-- ----------------------------
-- Table structure for lokhub_wf_approval_set
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_wf_approval_set`;
CREATE TABLE `lokhub_wf_approval_set`
(
...
-- ----------------------------
-- Records of lokhub_wf_approval_set
-- ----------------------------
BEGIN;
COMMIT;
