...
*/
CREATE DATABASE  `lokhub-project` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- ----------------------------
-- Table structure for lokhub_project
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project`;
CREATE TABLE `lokhub_project` (
...
-- ----------------------------
-- Table structure for lokhub_project_collection
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_collection`;
CREATE TABLE `lokhub_project_collection` (
  `id` varchar(64) NOT NULL COMMENT '主键id',
...
-- ----------------------------
-- Records of lokhub_project_collection
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for lokhub_project_file
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_file`;
CREATE TABLE `lokhub_project_file` (
  `id` varchar(64) NOT NULL COMMENT '主键id',
...
-- ----------------------------
-- Records of lokhub_project_file
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for lokhub_project_log
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_log`;
CREATE TABLE `lokhub_project_log` (
  `id` varchar(64) NOT NULL COMMENT '主键id',
...
-- ----------------------------
-- Records of lokhub_project_log
-- ----------------------------
BEGIN;
INSERT INTO `lokhub_project_log` (`id`, `user_id`, `type`, `operate_type`, `content`, `remark`, `pt_id`, `to_user_id`, `created_by`, `created_time`, `updated_by`, `updated_time`, `log_type`, `file_url`, `icon`, `project_id`) VALUES ('032fac95f33172ae8df72333ba257e6d', 173, 'task', 'addTask', 'f', '参与了任务', '0414ef914297d4bef45bf55ec6bba599', NULL, 'laige', '2024-05-31 13:58:25', 'laige', '2024-05-31 13:58:25', 1, NULL, NULL, 'aa3a0a9c72c6322d893768c3b05615fa');
...
-- ----------------------------
-- Table structure for lokhub_project_member
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_member`;
CREATE TABLE `lokhub_project_member` (
  `id` varchar(64) NOT NULL COMMENT '主键id',
  `pt_id` varchar(64) NOT NULL COMMENT '项目或者任务id',
...
-- ----------------------------
-- Records of lokhub_project_member
-- ----------------------------
BEGIN;
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('0c1d0483413d800a972f8f8598acc3d6', 'f0ddb49790bba0cc58b833470de0d48c', 1, '2024-04-01 14:59:21', 'admin', '2024-04-01 14:59:21', 'admin', '2024-04-01 14:59:21', 'task', 1);
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('3de03dda428830dde4e8a573d293aa79', 'c3e462c400f66fe0b68d9d2c1bef9ffc', 1, '2024-04-01 16:01:11', 'admin', '2024-04-01 16:01:11', 'admin', '2024-04-01 16:01:11', 'project', 1);
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('42c2b685177dd040587626f3f206325e', 'aa3a0a9c72c6322d893768c3b05615fa', 1, '2024-04-01 14:58:43', 'admin', '2024-04-01 14:58:43', 'admin', '2024-04-01 14:58:43', 'project', 1);
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('5d64e940bb99f2fa3f649df30104b614', 'aa3a0a9c72c6322d893768c3b05615fa', 173, '2024-04-04 01:39:16', 'admin', '2024-04-04 01:39:16', 'admin', '2024-04-04 01:39:16', 'project', 0);
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('8e3c1b48af1608c12b49b004c7580dc5', '0414ef914297d4bef45bf55ec6bba599', 173, '2024-05-31 13:58:25', 'laige', '2024-05-31 13:58:25', 'laige', '2024-05-31 13:58:25', 'task', 1);
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('9142a2503746eb0dd082c8b9ef466df9', '6dab92bed8d03d904962cca5dace9893', 1, '2024-04-01 15:15:40', 'admin', '2024-04-01 15:15:40', 'admin', '2024-04-01 15:15:40', 'task', 1);
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('936489d30d610e048cc4b9f8fd644401', '99b6803d35b3b474568bebf0f97722dc', 1, '2024-04-01 16:01:33', 'admin', '2024-04-01 16:01:33', 'admin', '2024-04-01 16:01:33', 'task', 1);
INSERT INTO `lokhub_project_member` (`id`, `pt_id`, `user_id`, `joined_time`, `created_by`, `created_time`, `updated_by`, `updated_time`, `type`, `creator`) VALUES ('9dac17d94f07e0db7e9a41b9774825ad', '4b3c00afaf7a6358b2108d465e0db48a', 1, '2024-04-01 14:59:40', 'admin', '2024-04-01 14:59:40', 'admin', '2024-04-01 14:59:40', 'task', 1);
COMMIT;

-- ----------------------------
-- Table structure for lokhub_project_stage
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_stage`;
CREATE TABLE `lokhub_project_stage` (
  `id` varchar(64) NOT NULL COMMENT '主键id',
...
-- ----------------------------
-- Records of lokhub_project_stage
-- ----------------------------
BEGIN;
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('0daaf2b9de2b3c9bcb9d7c89eeff9c03', 3, '交付验收阶段', NULL, 'c3e462c400f66fe0b68d9d2c1bef9ffc', 0, 'admin', '2024-04-01 16:01:10', 'admin', '2024-04-01 16:01:10');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('4325973a30ce9b9d7d5f1e4fa074891f', 2, '研发实施阶段', NULL, 'c3e462c400f66fe0b68d9d2c1bef9ffc', 0, 'admin', '2024-04-01 16:01:10', 'admin', '2024-04-01 16:01:10');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('5a3eda6d32b85df82964021a7a042159', 0, '项目立项阶段', NULL, 'c3e462c400f66fe0b68d9d2c1bef9ffc', 0, 'admin', '2024-04-01 16:01:10', 'admin', '2024-04-01 16:01:10');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('5c40e5da93bd6fc343a0909a9f01c73c', 3, '交付验收阶段', NULL, 'aa3a0a9c72c6322d893768c3b05615fa', 0, 'admin', '2024-04-01 14:58:43', 'admin', '2024-04-01 14:58:43');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('6359652deefcbc760893e79f55b23a20', 4, '新产品导出阶段', NULL, 'aa3a0a9c72c6322d893768c3b05615fa', 0, 'admin', '2024-04-01 14:58:43', 'admin', '2024-04-01 14:58:43');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('64a586191a41de633fba33976af476ca', 1, '研发设计输入阶段', NULL, 'aa3a0a9c72c6322d893768c3b05615fa', 0, 'admin', '2024-04-01 14:58:43', 'admin', '2024-04-01 14:58:43');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('83641c127c6514ff68222eb666f3cadf', 1, '研发设计输入阶段', NULL, 'c3e462c400f66fe0b68d9d2c1bef9ffc', 0, 'admin', '2024-04-01 16:01:10', 'admin', '2024-04-01 16:01:10');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('8c7441c41bcc7e824a7a4b3c1cd72d24', 2, '研发实施阶段', NULL, 'aa3a0a9c72c6322d893768c3b05615fa', 0, 'admin', '2024-04-01 14:58:43', 'admin', '2024-04-01 14:58:43');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('936cf8a130ce76e39b73e6e0ebe36800', 0, '项目立项阶段', NULL, 'aa3a0a9c72c6322d893768c3b05615fa', 0, 'admin', '2024-04-01 14:58:43', 'admin', '2024-04-01 14:58:43');
INSERT INTO `lokhub_project_stage` (`id`, `stage_code`, `stage_name`, `description`, `project_id`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('c459c5b373983888cf0a98055a95451f', 4, '新产品导出阶段', NULL, 'c3e462c400f66fe0b68d9d2c1bef9ffc', 0, 'admin', '2024-04-01 16:01:10', 'admin', '2024-04-01 16:01:10');
COMMIT;

-- ----------------------------
-- Table structure for lokhub_project_task
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_task`;
CREATE TABLE `lokhub_project_task` (
  `id` varchar(64) NOT NULL COMMENT '主键id',
  `created_by` varchar(64) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` varchar(64) DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Table structure for lokhub_project_task_notify
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_task_notify`;
CREATE TABLE `lokhub_project_task_notify` (
...
-- ----------------------------
-- Records of lokhub_project_task_notify
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for lokhub_project_task_process
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_task_process`;
CREATE TABLE `lokhub_project_task_process` (
  `id` varchar(64) NOT NULL,
...
-- ----------------------------
-- Records of lokhub_project_task_process
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for lokhub_project_task_work_time
-- ----------------------------
DROP TABLE IF EXISTS `lokhub_project_task_work_time`;
CREATE TABLE `lokhub_project_task_work_time` (
  `id` varchar(64) NOT NULL COMMENT '主键id',
...
-- ----------------------------
-- Records of lokhub_project_task_work_time
-- ----------------------------
BEGIN;
COMMIT;
