...
import { getTaskListApi, deleteTaskApi } from "@/api/lokhub-project/my-task.js"
import { getProjectListApi } from "@/api/dashboard/index.js"
import { getStageListApi, getProjectTaskListApi } from "@/api/lokhub-project/my-project.js"
...
export default {
  ...
  methods: {
    ...
    handleInfo(row) {
      this.$router.push({ path: "/lokhub-project/my-task/info", query: { taskId: row.taskId } })
    },
    handleDelete(row) {
      const data = {
