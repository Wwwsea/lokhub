...
import com.laigeoffer.lokhub.api.system.UserFeignService;
import com.laigeoffer.lokhub.api.system.domain.dto.SysUserDTO;
import com.laigeoffer.lokhub.api.workflow.DeployFeignService;
...
import com.laigeoffer.lokhub.base.core.core.domain.vo.SysUserVO;
import com.laigeoffer.lokhub.base.core.enums.LogTypeEnum;
import com.laigeoffer.lokhub.base.core.enums.ProjectStatusEnum;
import com.laigeoffer.lokhub.base.core.enums.ProjectTaskPriorityEnum;
import com.laigeoffer.lokhub.base.core.enums.ProjectTaskStatusEnum;
import com.laigeoffer.lokhub.base.core.exception.ServiceException;
import com.laigeoffer.lokhub.base.core.utils.DateUtils;
...
import com.laigeoffer.lokhub.project.domain.*;
import com.laigeoffer.lokhub.project.domain.vo.project.ProjectVO;
import com.laigeoffer.lokhub.project.domain.vo.project.log.*;
import com.laigeoffer.lokhub.project.domain.vo.project.member.ProjectMemberResVO;
import com.laigeoffer.lokhub.project.domain.vo.project.task.*;
import com.laigeoffer.lokhub.project.mapper.*;
import com.laigeoffer.lokhub.project.service.ProjectLogService;
import com.laigeoffer.lokhub.project.service.ProjectTaskService;
import com.laigeoffer.lokhub.project.service.task.QueryTaskLogFactory;
...
public class ProjectTaskServiceImpl extends ServiceImpl<ProjectTaskMapper, ProjectTask> implements ProjectTaskService {
    ...
    @Override
    @GlobalTransactional(name = "lokhub-project-addTask",rollbackFor = Exception.class) //seata分布式事务，AT模式
    public String add(TaskReqVO taskReqVO) {
        ...
        // 5、添加或更新审批设置（远程调用 lokhub-workflow 微服务）
...
//            // 设置任务详情地址
//            String url = SsoUrlUtils.ssoCreate(appid, agentid, host + path + ssoPath + URLEncoder.encode(host + "/lokhub-project/my-task/info?taskId=" + taskId));
...
//            taskAssignRemindDTO.setLinkUrl(OAUtils.ssoCreate(host + "/lokhub-project/my-task/info?taskId=" + taskId));
            // TODO: 2024.03.03 @fish 推送消息暂时关闭
...
//        }
    ...
    public void downloadTaskTemplate(HttpServletResponse response) throws IOException {
        String filePath = lokhubConfig.getProfile() + "/template/taskTemplate.xlsx";
        response.setContentType(MediaType.APPLICATION_OCTET_STREAM_VALUE);
