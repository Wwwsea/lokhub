package com.laigeoffer.lokhub.project.job;
...
import com.laigeoffer.lokhub.base.notice.domain.dto.TaskOvertimeRemindDTO;
import com.laigeoffer.lokhub.base.notice.utils.OAUtils;
import com.laigeoffer.lokhub.base.notice.utils.RocketMqUtils;
import com.laigeoffer.lokhub.base.notice.utils.SsoUrlUtils;
import com.laigeoffer.lokhub.project.domain.ProjectTaskNotify;
import com.laigeoffer.lokhub.project.domain.vo.project.task.TaskNotifyDTO;
import com.laigeoffer.lokhub.project.mapper.ProjectTaskMapper;
import com.laigeoffer.lokhub.project.mapper.ProjectTaskNotifyMapper;
...
import static com.laigeoffer.lokhub.base.notice.utils.MessageUtils.*;
import static com.laigeoffer.lokhub.base.notice.utils.SsoUrlUtils.ssoPath;
                ...
                .forEach(taskNotifyDTO -> {
                    ...
                    if (ChronoUnit.DAYS.between(localDate, closeDate) < 0L) {
                        ...
                        if (projectTaskNotify == null) {
                            ...
                            // 设置任务详情页
                            String url = SsoUrlUtils.ssoCreate(appid, agentid, host + path + ssoPath + URLEncoder.encode(host + "/lokhub-project/my-task/info?taskId=" + taskNotifyDTO.getTaskId()));
                            ...
                            taskOvertimeRemindDTO.setLinkUrl(OAUtils.ssoCreate(host + "/lokhub-project/my-task/info?taskId=" + taskNotifyDTO.getTaskId()));
