package com.laigeoffer.lokhub.base.core.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "lokhub")
public class lokhubConfig {
    /**
     * 上传路径
     */
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        lokhubConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        lokhubConfig.captchaType = captchaType;
    }
