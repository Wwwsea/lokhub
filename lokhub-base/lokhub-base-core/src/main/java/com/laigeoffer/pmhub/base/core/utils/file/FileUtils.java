...
import com.laigeoffer.lokhub.base.core.utils.uuid.IdUtils;
...
public class FileUtils {
     ...
     * @return
     */
    public static void writeBytes(byte[] file, HttpServletResponse response) throws IOException {
        FileInputStream fis = null;
        OutputStream os = null;
        try {
            os = response.getOutputStream();
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, lokhubConfig.getImportPath());
    }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/fish.png -- fish.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/fish.png -- fish
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
