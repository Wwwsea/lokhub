package com.laigeoffer.lokhub.base.notice.consumer;
...
import com.laigeoffer.lokhub.base.notice.domain.dto.*;
import com.laigeoffer.lokhub.base.notice.domain.entity.WxResult;
import com.laigeoffer.lokhub.base.notice.utils.MessageUtils;
...
public class OAMessageConsumer implements CommandLineRunner {
     ...
     * 消费组
     * */
    @Value("${lokhub.rocketMQ.group.wxMessage}")
