package com.laigeoffer.lokhub.common.utils;
...
public class OAUtils {
    ...
    @Value("${lokhub.oa.appId}")
    private void setAppId(String appId) {
        OAUtils.APPID = appId;
    }
    @Value("${lokhub.oa.code}")
    private void setCode(String code) {
        OAUtils.CODE = code;
    }


    @Value("${lokhub.oa.clientId}")
    private void setClientId(String clientId) {
        OAUtils.CLIENT_ID = clientId;
    }

    @Value("${lokhub.oa.clientSecret}")
