...
public class UploadTemplateFileExecutor extends UploadAbstractExecutor {
    ...
    public FileVO upload(LoginUser user, MultipartFile file, String id) throws Exception {
        ...
        String templatePath = FileUploadUtils.uploadTaskFile(lokhubConfig.getTemplatePath(), file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        ...
        String pn = FileUploadUtils.getPathName(lokhubConfig.getTemplatePath(), file);
