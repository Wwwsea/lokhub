...
public class UploadProjectFileExecutor extends UploadAbstractExecutor {
    ...
    public FileVO upload(LoginUser user, MultipartFile file, String id) throws Exception {
        ...
        String filePath = FileUploadUtils.uploadProjectFile(lokhubConfig.getProjectPath(), file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        String pathName = FileUploadUtils.getPathName(lokhubConfig.getProjectPath(), file);
