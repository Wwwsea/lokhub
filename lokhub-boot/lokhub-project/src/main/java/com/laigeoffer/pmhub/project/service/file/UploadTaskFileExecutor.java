...
public class UploadTaskFileExecutor extends UploadAbstractExecutor {
    ...
    public FileVO upload(LoginUser user, MultipartFile file, String id) throws Exception {
        ...
        String taskPath = FileUploadUtils.uploadTaskFile(lokhubConfig.getTaskPath(), file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        String pn = FileUploadUtils.getPathName(lokhubConfig.getTaskPath(), file);
