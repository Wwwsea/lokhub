...
import {
  ...
  addTaskCommentApi,
  getSubTaskListApi,
} from "@/api/lokhub-project/my-task.js"
import { getProjectListApi } from "@/api/dashboard/index.js"
import { getStageListApi, getFileListApi, deleteFileApi } from "@/api/lokhub-project/my-project.js"
...
export default {
  ...
  methods: {
    ...
    clickSubTask(taskId, taskName) {
      // this.$tab.openPage(`子任务-${taskName}`, `/lokhub-project/my-task/child/info?taskId=${taskId}`)
      this.$router.push({ path: "/lokhub-project/my-task/child/info", query: { taskId: taskId } })
    },
