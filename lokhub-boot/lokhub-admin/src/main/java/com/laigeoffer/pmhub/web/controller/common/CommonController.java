package com.laigeoffer.lokhub.web.controller.common;
...
import com.laigeoffer.lokhub.framework.config.ServerConfig;
...
import static com.laigeoffer.lokhub.common.utils.SecrecyUtils.*;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = lokhubConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = lokhubConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 本地资源路径
            String localPath = lokhubConfig.getProfile();
            // 数据库资源地址
