...
import com.laigeoffer.lokhub.project.service.ProjectFileService;
import com.laigeoffer.lokhub.project.service.file.UploadFileFactory;
...
import static com.laigeoffer.lokhub.common.core.domain.AjaxResult.error;
import static com.laigeoffer.lokhub.common.utils.SecurityUtils.getLoginUser;
...
public class ProjectFileController {
    ...
    public AjaxResult downloadFileList(@RequestParam("projectFileIds") String projectFileIds, HttpServletResponse response) {
        ...
        String totalZip = lokhubConfig.getProfile() + "/tmp.zip";
        if (CollectionUtils.isEmpty(Arrays.asList(projectFileIds.split(",")))) {
            return AjaxResult.error("未选择需要批量下载的文件");
        }
