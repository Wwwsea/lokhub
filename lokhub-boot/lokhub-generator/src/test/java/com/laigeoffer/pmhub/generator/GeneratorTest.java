package com.laigeoffer.lokhub.generator;
...
import com.laigeoffer.lokhub.common.core.domain.BaseCoreEntity;
...
public class GeneratorTest {
    ...
    final static String[] tables ={
            "lokhub_category_code_rule"

    };
    /**
     * 修改作者
     */
    private final static String AUTHOR = "fish";
    ...
    /** 1、数据源配置（开发or测试环境）  */
    // url
    private final static String DATASOURCE_URL = "jdbc:mysql://47.109.46.103:5506/lokhub-manage?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
    ...
    // 模块名称
    private final static String MODULE = "lokhub-" + YOUR_MODULE;
    ...
    /** 3、包配置(包名主要给模板引用)  */
    // 父包名
    private final static String PARENT = "com.laigeoffer.lokhub." + YOUR_MODULE;

    // controller包名
    private final static String PACK_CONTROLLER = "com.laigeoffer.lokhub.web.controller." + YOUR_MODULE;
    ...
    private final static String PATH_CONTROLLER = PROJECTPATH +  "/lokhub-admin/src/main/java/com/lokhub/web/controller/" + YOUR_MODULE;

    // service、serviceImpl、dto、vo、entity、mapper存储路径
    private final static String PATH_COMMON = PROJECTPATH + "/"  + MODULE +  "/src/main/java/com/lokhub/" + YOUR_MODULE;
    ...
    private final static String TABLE_PREFIX = "lokhub_";
