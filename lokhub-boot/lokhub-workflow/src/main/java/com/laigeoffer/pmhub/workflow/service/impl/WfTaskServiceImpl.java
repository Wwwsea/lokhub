package com.laigeoffer.lokhub.workflow.service.impl;
...
import com.laigeoffer.lokhub.common.enums.OAMessageStatusEnum;
...
import com.laigeoffer.lokhub.workflow.common.constant.ProcessConstants;
import com.laigeoffer.lokhub.workflow.common.constant.TaskConstants;
import com.laigeoffer.lokhub.workflow.common.enums.FlowComment;
import com.laigeoffer.lokhub.workflow.domain.bo.WfTaskBo;
import com.laigeoffer.lokhub.workflow.factory.FlowServiceFactory;
import com.laigeoffer.lokhub.workflow.service.IWfCopyService;
import com.laigeoffer.lokhub.workflow.service.IWfTaskService;
import com.laigeoffer.lokhub.workflow.domain.WfTaskMessageDeal;
import com.laigeoffer.lokhub.workflow.domain.WfTaskProcess;
import com.laigeoffer.lokhub.workflow.flow.CustomProcessDiagramGenerator;
import com.laigeoffer.lokhub.workflow.flow.FlowableUtils;
import com.laigeoffer.lokhub.workflow.mapper.ListenerMapper;
import com.laigeoffer.lokhub.workflow.mapper.WfCopyMapper;
import com.laigeoffer.lokhub.workflow.mapper.WfTaskMessageDealMapper;
import com.laigeoffer.lokhub.workflow.mapper.WfTaskProcessMapper;
import com.laigeoffer.lokhub.workflow.utils.ModelUtils;
import com.laigeoffer.lokhub.workflow.utils.TaskUtils;
...
//    private MaterialsUselessMapper materialsUselessMapper;
    ...
    public void stopProcess(WfTaskBo bo) {
        ...
        if(ObjectUtil.isEmpty(processInstance)){
            throw new RuntimeException("流程在审批中，且部分节点已被审批，不能取消，如确实需要取消申请，请联系审批人员驳回申请！");
        }
...
//        qw2.eq(WfMaterialsScrappedProcess::getInstanceId, bo.getProcInsId());
...
//        updateWrapper.eq(WfMaterialsScrappedProcess::getInstanceId, bo.getProcInsId())
//                .set(WfMaterialsScrappedProcess::getInstanceId, null)
//                .set(WfMaterialsScrappedProcess::getTaskId, null)
//                .set(WfMaterialsScrappedProcess::getUrl, null)
//                .set(WfMaterialsScrappedProcess::getUpdatedBy, SecurityUtils.getUsername())
//                .set(WfMaterialsScrappedProcess::getUpdatedTime, new Date());
//        updateWrapper.update();
//        if (CollectionUtils.isNotEmpty(ids)) {
//            LambdaQueryWrapper<MaterialsUseless> qw3 = new LambdaQueryWrapper<>();
//            qw3.in(MaterialsUseless::getRecordId, ids);
//            List<MaterialsUseless> mus = materialsUselessMapper.selectList(qw3);
//            mus.forEach(materialsUseless -> {
//                materialsUseless.setApproved(0);
//                materialsUselessMapper.updateById(materialsUseless);
//            });
//        }
