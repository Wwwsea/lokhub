package com.laigeoffer.lokhub.oa.domain.workWx.dto.body.notice;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.ObjectUtil;
import com.fasterxml.jackson.annotation.JsonSubTypes;
import com.fasterxml.jackson.annotation.JsonTypeInfo;
import com.laigeoffer.lokhub.oa.domain.workWx.Message;
import com.laigeoffer.lokhub.oa.domain.workWx.dto.message.module.TextCardDTO;
import com.laigeoffer.lokhub.oa.utils.StringCreateUtils;
import com.laigeoffer.lokhub.oa.domain.workWx.dto.message.body.notice.NoticeWxMessageDTO;
import lombok.Data;
...
@JsonSubTypes({
        @JsonSubTypes.Type(value = TodoRemindDTO.class, name = "待办提醒")
})
@EqualsAndHashCode(callSuper = true)
@Data
public class TodoRemindDTO extends Message {

    private static final String DESC = "<div class='gray'>%s</div> <div class='normal'>您目前还有【%s】个审批请求未处理，请及时处理</div>";
    private static final String MSG_TITLE = "待办任务提醒";
    private static final String BUTTON_TEXT = "前往处理";
    ...
    public NoticeWxMessageDTO toWxMessage(){
        ...
        textcard.setDescription(String.format(DESC, DateUtil.now(),num));
