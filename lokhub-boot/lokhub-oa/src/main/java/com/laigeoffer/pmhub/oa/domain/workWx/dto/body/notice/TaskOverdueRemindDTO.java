...
@JsonSubTypes({
        @JsonSubTypes.Type(value = TaskOverdueRemindDTO.class, name = "任务逾期提醒")
})
@EqualsAndHashCode(callSuper = true)
@Data
public class TaskOverdueRemindDTO extends Message {

    private static final String DESC = "<div class='gray'>%s</div> <div class='normal'>您的任务【%s】还有【%s】天到期，请及时处理！</div>";
    private static final String MSG_TITLE = "任务即将逾期提醒";
    ...
    public NoticeWxMessageDTO toWxMessage(){
        ...
        textcard.setDescription(String.format(DESC, DateUtil.now(),taskName,num));
