package com.laigeoffer.lokhub.oa.oa.consumer;
...
import com.laigeoffer.lokhub.oa.domain.workWx.dto.body.action.*;
import com.laigeoffer.lokhub.oa.domain.workWx.dto.body.action.*;
...
import com.laigeoffer.lokhub.oa.domain.workWx.dto.body.notice.TodoRemindDTO;
import com.laigeoffer.lokhub.oa.domain.workWx.dto.body.result.ProcessReturnDTO;
import com.laigeoffer.lokhub.oa.utils.MessageDataDTO;
import com.laigeoffer.lokhub.oa.utils.RedisUtils;
...
public class OAMessageConsumer implements CommandLineRunner {
     ...
     * 微信topic
     * */
//    @Value("${lokhub.rocketMQ.topic.wxMessage}")
...
//    @Value("${lokhub.rocketMQ.addr}")
     ...
     * 消费组
     * */
//    @Value("${lokhub.rocketMQ.topic.consumerGroup}")
