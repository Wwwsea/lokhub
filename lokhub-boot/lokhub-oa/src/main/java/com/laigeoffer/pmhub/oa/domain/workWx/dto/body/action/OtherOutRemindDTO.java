package com.laigeoffer.lokhub.oa.domain.workWx.dto.body.action;
...
import com.laigeoffer.lokhub.oa.domain.workWx.dto.message.body.template.ProcessWxMessageDTO;
import com.laigeoffer.lokhub.oa.domain.workWx.dto.message.module.*;
import com.laigeoffer.lokhub.oa.domain.workWx.dto.message.template.TemplateCardDTO;
import com.laigeoffer.lokhub.oa.enums.wx.CardTypeEnum;
...
@JsonSubTypes({
        @JsonSubTypes.Type(value = OtherOutRemindDTO.class, name = "其他出库审批提醒")
})
@EqualsAndHashCode(callSuper = true)
@Data
public class OtherOutRemindDTO extends Message {

    private String headDesc = "审批流程提醒";
    private String typeTitle = "您有一个新的其他出库审批提醒";
