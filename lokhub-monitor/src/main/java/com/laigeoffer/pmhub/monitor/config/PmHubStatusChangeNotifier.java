package com.laigeoffer.lokhub.monitor.config;
 ...
 */
@Component
public class lokhubStatusChangeNotifier extends AbstractStatusChangeNotifier {
    public lokhubStatusChangeNotifier(InstanceRepository repository) {
        super(repository);
    }
